...
import com.nikolastrapp.activitymanager.dtos.ActivityDto;
...
public class ActivityController {
    ...
    public ResponseEntity<Activity> addActivity(@RequestBody @Valid ActivityDto activityDto){
    ...
    public ResponseEntity<Activity> updateActivity(@PathVariable("id") Long id, @RequestBody @Valid ActivityDto activityDto){
        Activity activity = new Activity();
        BeanUtils.copyProperties(activityDto, activity);
